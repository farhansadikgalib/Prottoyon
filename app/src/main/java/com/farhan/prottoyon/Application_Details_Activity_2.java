...
public class Application_Details_Activity_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BackId.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(Application_Details_Activity_2.this, Activity_item2.class));
            }
        });
        //Back Button End
    }
