...
public class Adapter_item5 extends  RecyclerView.Adapter<Adapter_item6.ViewHolder> {

    private Context context;
    private List<ItemModel> itemModelList;

    public Adapter_item5(Context context, List<ItemModel> list) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Adapter_item6.ViewHolder holder, int position) {
